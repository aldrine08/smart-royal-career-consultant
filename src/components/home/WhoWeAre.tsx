        ...
        <div className="srcc-container py-24 md:py-32">
          ...
          <div className="identity-grid mt-14 grid gap-5 md:grid-cols-2">
            {identityCards.map((card) => (
              <article
                key={card.number}
                className="identity-card group relative overflow-hidden rounded-[1.5rem] border border-zinc-200 bg-white p-7 shadow-[var(--srcc-shadow-sm)] transition-all duration-500 hover:-translate-y-1 hover:shadow-[var(--srcc-shadow-md)] md:p-8"
              >
                <div className="flex items-center justify-between">
                  <span className="text-xs font-black tracking-[0.16em] text-[var(--srcc-purple)]">
                    {card.number}
                  </span>

                  <span className="h-2 w-2 rounded-full bg-[var(--srcc-gold)] transition-transform duration-500 group-hover:scale-150" />
                </div>

                <h4 className="mt-9 text-2xl font-black tracking-tight text-zinc-950">
                  {card.title}
                </h4>
                ...
                <div className="mt-8 h-px w-12 bg-zinc-200 transition-all duration-500 group-hover:w-20 group-hover:bg-[var(--srcc-gold)]" />
              </article>
            ))}
          </div>
        </div>
